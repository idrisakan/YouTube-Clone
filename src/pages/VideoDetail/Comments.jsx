      ...
      {data.data.map((i, key) => (
        <div key={key} className="flex gap-2 items-start px-1 py-4">
          <img
            ...
            src={i.authorThumbnail[0].url} alt="logo" />
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className='flex gap-5 items-center'>
              <div className='flex gap-1 p-1 rounded cursor-pointer hover:bg-zinc-700'>
                <AiOutlineLike />
                {i.likesCount}
              </div>
          ...
          {i.replyCount > 0 && (  <div className='flex w-fit items-center p-1 rounded-md cursor-pointer gap-2 text-blue-500 hover:bg-[#36639662]'>
              <TiArrowSortedDown />
              {i.replyCount} yanıt
           </div>)}
          </div>
