...
const VideoCard = ({ video, isRow }) => {
    ...
    //veri tipi video değilse / short list vs. olabiliyor bileşen hiçbir şey render etmesin
    ...
    return (
        <div
            ...
            <div className="flex gap-4 mt-5">
                <img src={video.channelThumbnail && video.channelThumbnail[0].url} alt="logo"
